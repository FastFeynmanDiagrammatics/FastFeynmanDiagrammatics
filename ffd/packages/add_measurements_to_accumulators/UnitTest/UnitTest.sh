...
unit_test_flag="-DFFD_ADD_MEASUREMENTS_TO_ACCUMULATORS_UNIT_TEST_FLAG"
...
$cpp_comp $cpp_std $slow_flag $warning_flags $debug_flag $error_limit_cmd=$max_errors $unit_test_flag -I $ffd_path $cpp_file -o $slow_file
