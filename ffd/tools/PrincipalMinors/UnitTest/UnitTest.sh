...
g++ -std=c++17 -O0 -Wall -DFFD_PRINCIPAL_MINORS_UNIT_TEST_FLAG -I ../../../../ UnitTest.cpp -o .UnitTest.x

echo slow version compiled.

#g++ -std=c++17 -Ofast -Wall -Wfatal-errors -DFFD_PRINCIPAL_MINORS_UNIT_TEST_FLAG -I ../../../../ UnitTest.cpp -o .FastUnitTest.x
