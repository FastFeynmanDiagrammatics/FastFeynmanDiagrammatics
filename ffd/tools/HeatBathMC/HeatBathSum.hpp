namespace ffd::heat_bath_mc{
  ...
  HeatBathSum(
    ...
    auto const [times, chosen_set] = heat_bath_fluxes_sum<max_order, max_calculated_order>(fluxes, U);
    // auto const [times, chosen_set] = heat_bath_fluxes_sum_post<max_order, max_calculated_order>(fluxes, U);
