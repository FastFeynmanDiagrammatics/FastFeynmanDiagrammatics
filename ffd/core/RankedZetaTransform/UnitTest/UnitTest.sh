...
g++ -std=c++17 -O0 -Wextra -Wall -Wfatal-errors -DFFD_UNIT_TEST_FLAG -I ../../../../ UnitTest.cpp -o .UnitTest.x 

echo slow version compiled.

#g++ -std=c++17 -Ofast -Wextra -Wall -Wfatal-errors -DFFD_UNIT_TEST_FLAG -I ../../../../ UnitTest.cpp -o .FastUnitTest.x
